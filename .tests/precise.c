 ...
 *
	...
	printf("WIDTH & PRECISION\n");
	p1 = printf("what does this look like? %15.11x*\n", 2387123);
	p2 = printf("what does this look like? %15.12x*\n", 2387123);
	p3 = printf("what does this look like? %15.13x*\n", 2387123);
	p4 = printf("what does this look like? %15.14X*\n", 2387123);
	p5 = printf("what does this look like? %15.15X*\n", 2387123);
	fp1 = ft_printf("what does this look like? %15.11x.\n", 2387123);
	fp2 = ft_printf("what does this look like? %15.12x.\n", 2387123);
	fp3 = ft_printf("what does this look like? %15.13x.\n", 2387123);
	fp4 = ft_printf("what does this look like? %15.14X.\n", 2387123);
	fp5 = ft_printf("what does this look like? %15.15X.\n", 2387123);
	...
	printf("WIDTH\n");
	p1 = printf("what does this look like? %6d*\n", 1);
	p2 = printf("what does this look like? %7d*\n", 2);
	p3 = printf("what does this look like? %8d*\n", 1);
	p4 = printf("what does this look like? %9d*\n", 2);
	p5 = printf("what does this look like? %10d*\n", 1);
	fp1 = ft_printf("what does this look like? %6d.\n", 1);
	fp2 = ft_printf("what does this look like? %7d.\n", 2);
	fp3 = ft_printf("what does this look like? %8d.\n", 1);
	fp4 = ft_printf("what does this look like? %9d.\n", 2);
	fp5 = ft_printf("what does this look like? %10d.\n", 1);
