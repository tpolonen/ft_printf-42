...
int main(void)
{
	...
	printf("justhex\n");
	pf =    printf("%x", 666); printf(" p\n");
	fp = ft_printf("%x", 666); printf(" f\n");
	printf("pf[%d] fp[%d]\n\n", pf, fp);

	printf("hex&width\n");
	pf =    printf("%12x", 666); printf(" p\n");
	fp = ft_printf("%12x", 666); printf(" f\n");
	printf("pf[%d] fp[%d]\n\n", pf, fp);
	...
	pf =    printf("%15.12x", 666); printf(" p\n");
	fp = ft_printf("%15.12x", 666); printf(" f\n");
	printf("pf[%d] fp[%d]\n\n", pf, fp);

	printf("hex&prec>width\n");
	pf =    printf("%12.15x", 666); printf(" p\n");
	fp = ft_printf("%12.15x", 666); printf(" f\n");
	printf("pf[%d] fp[%d]\n\n", pf, fp);
	...
	printf("-----------------------\nZERO FLAG\n--------------------\n\n");
	printf("justhex\n");
	pf =    printf("%0x", 666); printf(" p\n");
	fp = ft_printf("%0x", 666); printf(" f\n");
	printf("pf[%d] fp[%d]\n\n", pf, fp);

	printf("hex&width\n");
	pf =    printf("%012x", 666); printf(" p\n");
	fp = ft_printf("%012x", 666); printf(" f\n");
	printf("pf[%d] fp[%d]\n\n", pf, fp);

	printf("hex&prec\n");
	pf =    printf("%0.12x", 666); printf(" p\n");
	fp = ft_printf("%0.12x", 666); printf(" f\n");
	printf("pf[%d] fp[%d]\n\n", pf, fp);

	printf("hex&prec<width\n");
	pf =    printf("%015.12x", 666); printf(" p\n");
	fp = ft_printf("%015.12x", 666); printf(" f\n");
	printf("pf[%d] fp[%d]\n\n", pf, fp);

	printf("hex&prec>width\n");
	pf =    printf("%012.15x", 666); printf(" p\n");
	fp = ft_printf("%012.15x", 666); printf(" f\n");
	printf("pf[%d] fp[%d]\n\n", pf, fp);
